<template>
    <div class="card mb-3">
        <div class="card-body d-flex">
            <h4 class="text-primary">Agregar Nuevo Medico</h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3">
                ...
                <div class="col-12">
                    <button type="button" class="btn btn-success" v-on:click="newMedical()">Guardar</button>
                </div>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        newMedical(){
            axios.post(`http://127.0.0.1:8000/medical/`, this.form, { headers: {} })
            .then((result) => {
